...
export default function LabStatus() {
  ...
  const [roomData, setRoomData] = useState({
    ...
    tables: [
      ...
      { id: 1, name: 1, x: 615, y: 80 },
      { id: 2, name: 2, x: 665, y: 80 },

      { id: 3, name: 3, x: 319, y: 130 },
      { id: 4, name: 4, x: 370, y: 130 },
      { id: 5, name: 5, x: 420, y: 130 },
      { id: 6, name: 6, x: 495, y: 130 },
      { id: 7, name: 7, x: 545, y: 130 },
      { id: 8, name: 8, x: 615, y: 130 },
      { id: 9, name: 9, x: 665, y: 130 },

      { id: 10, name: 10, x: 319, y: 180 },
      { id: 11, name: 11, x: 370, y: 180 },
      { id: 12, name: 12, x: 420, y: 180 },
      { id: 13, name: 13, x: 495, y: 180 },
      { id: 14, name: 14, x: 545, y: 180 },
      { id: 15, name: 15, x: 615, y: 180 },
      { id: 16, name: 16, x: 665, y: 180 },

      { id: 17, name: 17, x: 319, y: 230 },
      { id: 18, name: 18, x: 370, y: 230 },
      { id: 19, name: 19, x: 420, y: 230 },
      { id: 20, name: 20, x: 495, y: 230 },
      { id: 21, name: 21, x: 545, y: 230 },
      { id: 22, name: 22, x: 615, y: 230 },
      { id: 23, name: 23, x: 665, y: 230 },

      { id: 24, name: 24, x: 319, y: 280 },
      { id: 25, name: 25, x: 370, y: 280 },
      { id: 26, name: 26, x: 420, y: 280 },
      { id: 27, name: 27, x: 495, y: 280 },
      { id: 28, name: 28, x: 545, y: 280 },
      { id: 29, name: 29, x: 615, y: 280 },
      { id: 30, name: 30, x: 665, y: 280 },

      { id: 31, name: 31, x: 319, y: 330 },
      { id: 32, name: 32, x: 370, y: 330 },
      { id: 33, name: 33, x: 420, y: 330 },
      { id: 34, name: 34, x: 495, y: 330 },
      { id: 35, name: 35, x: 545, y: 330 },
      { id: 36, name: 36, x: 615, y: 330 },
      { id: 37, name: 37, x: 665, y: 330 },

      { id: 38, name: 38, x: 319, y: 380 },
      { id: 39, name: 39, x: 370, y: 380 },
      { id: 40, name: 40, x: 420, y: 380 },
      { id: 41, name: 41, x: 495, y: 380 },
      { id: 42, name: 42, x: 545, y: 380 },
      { id: 43, name: 43, x: 615, y: 380 },
      { id: 44, name: 44, x: 665, y: 380 },

      { id: 45, name: 45, x: 319, y: 430 },
      { id: 46, name: 46, x: 370, y: 430 },
      { id: 47, name: 47, x: 420, y: 430 },
      { id: 48, name: 48, x: 495, y: 430 },
      { id: 49, name: 49, x: 545, y: 430 },
      { id: 50, name: 50, x: 615, y: 430 },
      { id: 51, name: 51, x: 665, y: 430 },

      { id: 52, name: 52, x: 319, y: 480 },
      { id: 53, name: 53, x: 370, y: 480 },
      { id: 54, name: 54, x: 420, y: 480 },
      { id: 55, name: 55, x: 495, y: 480 },
      { id: 56, name: 56, x: 545, y: 480 },

      { id: 57, name: 57, x: 319, y: 530 },
      { id: 58, name: 58, x: 370, y: 530 },
      { id: 59, name: 59, x: 420, y: 530 },
      { id: 60, name: 60, x: 495, y: 530 },
      { id: 61, name: 61, x: 545, y: 530 },

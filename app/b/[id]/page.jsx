      ...
      session.user && (
        <>
            ...
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-start rtl:justify-end">
                  ...
                  <Link href={"/"} className={`text-xl font-semibold text-blue-600 dark:text-blue-400 ${kanit.className}`}>
                    Booking Lab
                  </Link>
                </div>
          ...
          <aside
            ...
            aria-label="Sidebar"
          >
            <div className={`h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800 ${kanit.className}`}>
              <ul className="space-y-2 font-medium">
                <li>
                  <Link href={`/b/${id}`} className="flex items-center p-2 pl-4 text-white rounded-lg bg-primary group">

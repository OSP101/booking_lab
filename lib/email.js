...
export async function sendResetEmail(email, token) {
    ...
    const expirationTime = "10 นาที / minutes";
        ...
        const response = await resend.emails.send({
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 500px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
                    ...
                    <p style="color: #555; text-align: center;">เราได้รับคำขอให้รีเซ็ตรหัสผ่านของคุณ กรุณาคลิกปุ่มด้านล่างเพื่อดำเนินการ <br/> We received a request to reset your password. Click the button below to proceed:</p>
                    ...
                    <p style="color: #777; font-size: 12px; text-align: center;">
                        ลิงก์นี้จะหมดอายุใน <b>${expirationTime}</b> หากคุณไม่ได้ร้องขอ กรุณาเพิกเฉยต่ออีเมลนี้ <br/>
